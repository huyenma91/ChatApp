...
public class demoGUI {
    ...
    public demoGUI(String server_ip, int server_port, int peer_port, String username, String message) throws Exception {
    ...
    private void initializeLabel() {
        ...
        lbUsername.setFont(new Font("Verdana",1,10));
